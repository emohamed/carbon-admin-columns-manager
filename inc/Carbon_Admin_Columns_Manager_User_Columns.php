...
class Carbon_Admin_Columns_Manager_User_Columns extends Carbon_Admin_Columns_Manager {
	public $admin_screen_type = "user_columns";
	...
	public function add( $columns ) {
		...
		foreach ($columns as $column_index => $column) {
			...
			$defined_columns[$column_index] = array(
				...
				'callback_function' => $column->callback
			);
		}
	...
	public function get_cols_list_filter_name( $null ) {
		return 'manage_users_columns';
	}

	public function get_col_content_filter_name( $null ) {
		return 'manage_users_custom_column';
	}

	public function get_sortable_filter_name( $null ) {
